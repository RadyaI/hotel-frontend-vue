                ...
                <div class="container">
                    ...
                    <div v-for="booking in filterdata" :key="booking.id_transaksi" class="card mt-2">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><b>Check-In:</b> {{ booking.check_in }} <br> <b>Check-Out:</b> {{
                                booking.check_out
                            }}
                            </p>
                            <!-- <p class="card-text">
                                ...
                                <span v-else-if="booking.status == 'dikonfirmasi'">Status: <span class="text-success">Sudah
                                        Di
                                        Konfirmasi</span></span>
...
export default {
    ...
    methods: {
        getdata() {
            axios.get('http://localhost:8000/api/gettransaksi')
                .then(
                    ({ data }) => {
