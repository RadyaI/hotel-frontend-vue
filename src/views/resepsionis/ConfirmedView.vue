                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" id="no_kamar" required v-model="no_kamar"
                                        @keyup="checkkamar">
                                    <span v-if="this.no_kamar == ''"><small>*required</small></span>
                                    <small v-if="showalert" class="text-danger">*Kamar Sudah di pakai</small>
                                </div>
                                <div class="col">
