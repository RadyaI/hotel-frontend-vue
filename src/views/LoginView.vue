                                            ...
                                            <div class="section text-center">
                                                ...
                                                <form @submit.prevent="login">
                                                    <div class="form-group">
                                                        <input type="email" v-model="email" name="logemail"
                                                            class="form-style" placeholder="Your Email" id="logemail"
                                                            autocomplete="off">
                                                        <i cla ss="input-icon uil uil-at"></i>
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        <input type="password" v-model="password" name="logpass"
                ...
                .then(
                    (response) => {
                        ...
                        if (response.data.level === "admin") {
                            location.href = '/admin'
                        } else if (response.data.level === "resepsionis") {
